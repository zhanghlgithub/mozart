#ifndef __LIB_CAMERA_H__
#define __LIB_CAMERA_H__
...
extern void iq_camera_close(int fd);
extern int iq_camera_open(const char * dev_name);
extern int iq_camera_init_disp_info(struct display_info *disp);
extern int iq_camera_start(struct display_info *disp,void *handle);
extern int iq_camera_stop(struct display_info * disp_info);
extern int iq_camera_get_frames();
